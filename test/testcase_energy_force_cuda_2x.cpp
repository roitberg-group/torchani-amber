...
TEST_CASE("Energy + force CUDA 2x", "[CUDA]"){
    ...
    SECTION("Test on CUDA device double precision", "[CUDA]"){
        int use_cuda_device = 1;
        int device_index = 0;
        ...
        std::ifstream infile(file_directory + "test_values_cuda_2x.txt");
        double value;
    ...
    SECTION("Test on CUDA device single precision", "[CUDA]"){
        int use_cuda_device = 1;
        int device_index = 0;
